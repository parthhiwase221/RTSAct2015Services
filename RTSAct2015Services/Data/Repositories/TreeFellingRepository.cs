...
{
    public class TreeFellingRepository : ITreeFellingRepository
    {
        private readonly IConfiguration _configuration;
        private readonly string _connectionString;

        public TreeFellingRepository(IConfiguration configuration)
        {
        ...
        public async Task<string> InsertApplicationAsync(TreeFellingCreateDto dto)
        {
            ...
            parameters.Add("@ApplicationType", "TREE_FELLING", DbType.String);
            parameters.Add("@FormName", "Tree Felling Application", DbType.String);
            ...
            // Tree Felling Specific Fields
            parameters.Add("@TreeFellingReason", dto.ReasonForFelling, DbType.String);
            ...
            parameters.Add("@NoOfTreeFelling", dto.NoOfTreeFelling, DbType.Int32);
            ...
            parameters.Add("@FormCDFile", dto.FormCDFilePath, DbType.String);

            // Terms
            parameters.Add("@TermsAccepted", $"Term1:{dto.TermsCondition1},Term2:{dto.TermsCondition2},Term3:{dto.TermsCondition3},Term4:{dto.TermsCondition4}", DbType.String);
            ...
            var complaintNumber = await connection.QuerySingleOrDefaultAsync<string>(
                "SELECT TOP 1 ApplicationID FROM Applications WHERE ApplicationType = 'TREE_FELLING' ORDER BY ID DESC"
            );

            return complaintNumber ?? "TFL00000";
        }
            ...
            string? searchText = null)
        {
            ...
            var sql = @"
                ...
                WHERE ApplicationType = 'TREE_FELLING' AND IsActive = 1
        ...
        public async Task<bool> UpdateApplicationAsync(string applicationId, TreeFellingCreateDto dto)
        {
            using var connection = CreateConnection();
            ...
            string? searchText = null)
        {
            ...
            var sql = "SELECT COUNT(1) FROM Applications WHERE ApplicationType = 'TREE_FELLING' AND IsActive = 1";
