...
{
    public interface ITreeTrimmingService
    {
        Task<ResponseDto<ApplicationResponseDto>> CreateApplicationAsync(TreeTrimmingCreateDto createDto);
        ...
        Task<ResponseDto<bool>> UpdateApplicationAsync(string applicationId, TreeTrimmingCreateDto updateDto);
