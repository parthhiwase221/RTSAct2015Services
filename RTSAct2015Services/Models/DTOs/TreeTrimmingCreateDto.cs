...
{
    public class TreeTrimmingCreateDto
    {
        // Personal Details
        ...
        // Address Details - **FIXED: Updated field names**
        ...
        // **NEW: File Path Properties for stored files**
        ...
        public string? NOCLetterFilePath { get; set; }

        // Tree Trimming specific properties
        [Required(ErrorMessage = "Reason for trimming is required")]
        ...
        [Required(ErrorMessage = "Tree count is required")]
        [Range(1, 50, ErrorMessage = "Tree count must be between 1 and 50")]
        public int TreeCount { get; set; }

        public string? TreeSpecies { get; set; }
        public string? OtherReason { get; set; }

        // **NEW: File Upload Properties for form files**
        ...
        public IFormFile? NOCLetterFile { get; set; }
        public IFormFile? DocumentFile { get; set; }

        // **FIXED: Terms and Conditions - Simple bool properties**
        ...
        public bool TermsCondition5 { get; set; } = false;
        public bool TermsCondition6 { get; set; } = false;
